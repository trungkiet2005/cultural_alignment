#!/usr/bin/env python3
"""
Paper sweep — Qwen2.5-7B-Instruct (vLLM) — EXP-24 (DPBR), 20 countries
====================================================================

Unsloth 4-bit ref: unsloth/Qwen2.5-7B-Instruct-bnb-4bit
Upstream vLLM: Qwen/Qwen2.5-7B-Instruct

Kaggle:
    !python exp_paper/models/exp_paper_qwen25_7b.py
"""

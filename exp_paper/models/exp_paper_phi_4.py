#!/usr/bin/env python3
"""
Paper sweep — Phi-4 — EXP-24 (DPBR), 20 countries
=================================================

Model : microsoft/phi-4 (vLLM)
Method: EXP-24 Dual-Pass Bootstrap IS Reliability (DPBR); same core as ``exp_model/_base_dpbr.py``.

#!/usr/bin/env python3
"""
Paper sweep — Magistral-Small-2509 (vLLM) — EXP-24 (DPBR), 20 countries
=======================================================================

Model : mistralai/Magistral-Small-2509 (vLLM)
Method: EXP-24 DPBR

Kaggle:
    !python exp_paper/models/exp_paper_magistral_small_2509.py
"""

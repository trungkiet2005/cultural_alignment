...
Usage:
    !python /kaggle/input/cultural-alignment/exp_paper/ablation/exp_paper_ablation_qwen25_7b.py
...
_RESULTS_BASE = (
    ...
    if _on_kaggle()
    else str(Path(__file__).parent.parent.parent / "results" / "exp24_ablation_qwen25_7b")
)

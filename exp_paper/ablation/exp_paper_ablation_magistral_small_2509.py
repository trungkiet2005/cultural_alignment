...
Usage:
    !python /kaggle/input/cultural-alignment/exp_paper/ablation/exp_paper_ablation_magistral_small_2509.py
...
import exp_paper.ablation.exp_paper_ablation_phi4 as _abl  # noqa: E402
...
_RESULTS_BASE = (
    ...
    if _on_kaggle()
    else str(Path(__file__).parent.parent.parent / "results" / "exp24_ablation_magistral_small_2509")
)

...
[`exp_paper/round2/`](../). All originally produced on Kaggle H100, then
...
```bash
R2_RESULTS_BASE="$(pwd)" python exp_paper/round2/phase5_analysis/aggregate_round2.py
R2_RESULTS_BASE="$(pwd)" python exp_paper/round2/phase5_analysis/wvs_dimension_matrix.py
R2_RESULTS_BASE="$(pwd)" python exp_paper/round2/phase5_analysis/logit_gain_correlation.py
R2_RESULTS_BASE="$(pwd)" python exp_paper/round2/phase7_oral/aggregate_phase7.py
```

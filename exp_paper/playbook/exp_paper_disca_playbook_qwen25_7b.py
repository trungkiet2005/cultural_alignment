...
Usage on Kaggle:
  ...
  !python /kaggle/input/cultural-alignment/exp_paper/playbook/exp_paper_disca_playbook_qwen25_7b.py
...
RESULTS_BASE = (
    ...
    if _on_kaggle()
    else str(Path(__file__).parent.parent.parent / "results" / "exp24_playbook_qwen25_7b")
)

...
Two-step run (each step is independent):
  ...
  Step 1 (GPU, ~30 min on H100 per model): vanilla logit-conditioning
    !python exp_paper/review/round3/posthoc/exp_r3_logit_conditioning_cross_model.py
  ...
  Step 2 (CPU, post-hoc): aggregate against SWA-DPBR per-country MIS gains
    !python exp_paper/review/round3/posthoc/exp_r3_logit_conditioning_cross_model.py --aggregate-only

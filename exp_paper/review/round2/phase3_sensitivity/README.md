...
```python
!python exp_paper/review/round2/phase3_sensitivity/exp_r2_logit_conditioning.py      # ~30 min
!python exp_paper/review/round2/phase3_sensitivity/exp_r2_persona_variant.py         # ~2 h
!R2_N_SCENARIOS=250 python exp_paper/review/round2/phase3_sensitivity/exp_r2_hparam_sensitivity.py   # ~6 h at default
!python exp_paper/review/round2/phase3_sensitivity/exp_r2_wvs_dropout.py             # ~2 h
!python exp_paper/review/round2/phase3_sensitivity/exp_r2_no_oversampling.py         # ~2 h
```

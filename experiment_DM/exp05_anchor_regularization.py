...
def main() -> None:
    ...
    print(f"\n[{EXP_ID}] DONE.")
    print("Key diagnostics to check in results:")
    print("  mean_alpha_reg: close to 1.0 = Qwen (ESS high, standard update)")
    print("  mean_alpha_reg: close to rho_eff = Gemma USA (ESS low, regularized)")
    print("  mean_anchor_div: large (e.g. >0.5) = where regularization has most impact")

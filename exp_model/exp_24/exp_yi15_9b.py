#!/usr/bin/env python3
"""
EXP-24 Dual-Pass Bootstrap IS — Yi-1.5-9B-Chat (4-bit)
======================================================

Model  : unsloth/Yi-1.5-9B-Chat-bnb-4bit
...
Usage on Kaggle
---------------
    !python exp_model/exp_24/exp_yi15_9b.py
...
# Step 1: model config
# ============================================================
MODEL_NAME  = "unsloth/Yi-1.5-9B-Chat-bnb-4bit"
MODEL_SHORT = "yi15_9b"

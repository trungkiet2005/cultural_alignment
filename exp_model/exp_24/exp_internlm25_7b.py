#!/usr/bin/env python3
"""
EXP-24 Dual-Pass Bootstrap IS — InternLM2.5-7B-Chat (4-bit)
===========================================================

Model  : unsloth/internlm2_5-7b-chat-bnb-4bit
...
Usage on Kaggle
---------------
    !python exp_model/exp_24/exp_internlm25_7b.py
...
# Step 1: model config
# ============================================================
MODEL_NAME  = "unsloth/internlm2_5-7b-chat-bnb-4bit"
MODEL_SHORT = "internlm25_7b"

...
def _install_deps() -> None:
    if not _on_kaggle():
        return
    # Notebook (new/unsloth-deepseek-r1-0528-qwen3-8b.ipynb) pins transformers==4.56.2.
    for cmd in [
...
MODEL_SHORT = "deepseek_r1_0528_qwen3_8b"

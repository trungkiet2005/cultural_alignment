#!/usr/bin/env python3
"""
EXP-24 Dual-Pass Bootstrap IS — Phi-3-medium — Phi_3_Medium_Conversational.ipynb
==================================================================================

Model  : unsloth/Phi-3-medium-4k-instruct
...
Usage on Kaggle
---------------
    !python exp_model/exp_24/exp_phi3_medium.py

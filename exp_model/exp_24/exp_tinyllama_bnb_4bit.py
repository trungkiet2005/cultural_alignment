#!/usr/bin/env python3
"""
EXP-24 Dual-Pass Bootstrap IS — TinyLlama (4-bit)
================================================

Model  : unsloth/tinyllama-bnb-4bit
Profile: pypi  (pip stack aligned with Reference_Notebook_Model/new)
Notebook: Reference_Notebook_Model/new/unsloth-tinyllama-bnb-4bit.ipynb
Method : Dual-Pass Bootstrap IS Reliability (DPBR) — identical to EXP-24
Base   : EXP-09 Hierarchical IS  (SOTA MIS=0.3975)

Usage on Kaggle
---------------
    !python exp_model/exp_24/exp_tinyllama_bnb_4bit.py

Note: Notebook also mentions unsloth/tinyllama for 16-bit loading; this script uses the 4-bit Unsloth bundle.
...
MODEL_SHORT = "tinyllama_bnb_4bit"

#!/usr/bin/env python3
"""
EXP-24 Dual-Pass Bootstrap IS — Ministral-3-3B — Ministral_3_VL_(3B)_Vision.ipynb
===================================================================================

Model  : unsloth/Ministral-3-3B-Instruct-2512
Profile: ref_qwen35  (pip stack aligned with Reference_Notebook_Model where noted)
Method : Dual-Pass Bootstrap IS Reliability (DPBR) — identical to EXP-24
Base   : EXP-09 Hierarchical IS  (SOTA MIS=0.3975)

Usage on Kaggle
---------------
    !python exp_model/exp_24/exp_ministral3_vl_3b.py

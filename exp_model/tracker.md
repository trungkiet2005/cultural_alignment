...
| 2 | EXP-09-LLAMA33_70B | Hierarchical IS | Llama-3.3-70B-Instruct-bnb-4bit | 1 model x 5 countries | 0.5237 | 0.1256 | +0.247 | 16.42 | 16.5% | Win vs vanilla: 5/5, macro +25.85%; pypi Unsloth (TF 5.2.0), ~40 GB VRAM |
| 3 | EXP-24-QWEN3_VL_8B | Dual-Pass Bootstrap IS Reliability (DPBR) | Qwen3-VL-8B | 1 model x 5 countries | **0.3813** | 0.0871 | +0.446 | 11.81 | 15.15% | Win vs vanilla: 4/5, macro +23.74% |
...
## Run: EXP-24-GEMMA4_31B

- Date: 2026-04-11
- Script: `exp_model/exp_24/exp_gemma4_31b.py`
- Model: `unsloth/gemma-4-31B-it` (`MODEL_SHORT`: `gemma4_31b`)
- Notebook: `Reference_Notebook_Model/gemma4-31b-unsloth.ipynb`
- Profile: **ref_gemma4** — `torchcodec`, `timm`, `transformers==5.5.0`, `unsloth_zoo>=2026.4.6`, PyPI `unsloth`; `datasets` 3.4.x–4.4.x.
- Method: Dual-Pass Bootstrap IS Reliability (DPBR)
- Output dir: `/kaggle/working/cultural_alignment/results/exp24_model_sweep/gemma4_31b/compare`
- Environment (Kaggle): 1× **NVIDIA H100 80GB**; Unsloth **2026.4.4** (“Fast Gemma4 patching”); Transformers **5.5.0**; Torch **2.9.0+cu126**; bfloat16; ~**19.14 GB** VRAM; decision token ids **A=236776 (`'A'`), B=236799 (`'B'`)** (same id family as Gemma 3 in tracker). Vanilla uses Gemma-4 turn format (`<bos><|turn>user` … `<|turn>model`). Flash Attention 2 warning → **Xformers** / no FA2 in log.

### Vanilla baseline (token-logit, no personas / no IS)

| Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ |
|:-------:|:-----:|:-----:|:-----------:|:-----:|
| BRA | 0.2635 | 0.0458 | +0.449 | 8.45 |
| CHN | 0.4693 | 0.0555 | +0.522 | 17.38 |
| DEU | 0.2477 | 0.0429 | +0.824 | 8.01 |
| JPN | 0.4717 | 0.0780 | +0.045 | 15.95 |
| USA | 0.4169 | 0.0628 | +0.588 | 14.74 |

- Mean vanilla MIS: **0.3738**

### Full Metrics (DPBR)

| Model | Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ | Flip% |
|:------|:-------:|:-----:|:-----:|:-----------:|:-----:|:-----:|
| gemma-4-31B-it | BRA | 0.2638 | 0.0180 | +0.927 | 10.34 | 16.8% |
| gemma-4-31B-it | CHN | 0.4564 | 0.0741 | -0.400 | 14.95 | 24.8% |
| gemma-4-31B-it | DEU | 0.4785 | 0.0645 | +0.304 | 16.89 | 24.8% |
| gemma-4-31B-it | JPN | 0.4880 | 0.0562 | +0.088 | 17.97 | 27.4% |
| gemma-4-31B-it | USA | 0.4227 | 0.0452 | +0.561 | 15.64 | 19.4% |

### vs Vanilla (MIS)

| Model | Country | Vanilla MIS | DPBR MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|------------:|---------:|----------------:|--------:|:----:|
| gemma-4-31B-it | BRA | 0.2635 | 0.2638 | -0.0002 | -0.09% | ❌ |
| gemma-4-31B-it | CHN | 0.4693 | 0.4564 | +0.0130 | +2.76% | ✅ |
| gemma-4-31B-it | DEU | 0.2477 | 0.4785 | -0.2307 | -93.13% | ❌ |
| gemma-4-31B-it | JPN | 0.4717 | 0.4880 | -0.0163 | -3.46% | ❌ |
| gemma-4-31B-it | USA | 0.4169 | 0.4227 | -0.0058 | -1.39% | ❌ |

- Win rate: **1/5**
- Mean vanilla MIS: **0.3738**
- Mean DPBR MIS: **0.4219**
- Macro improvement: **-12.85%**
- Mean per-row improvement (micro): **-19.06%**

### vs EXP-01 SWA-PTIS (MIS)

| Model | Country | EXP-01 MIS | DPBR MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|-----------:|---------:|----------------:|--------:|:----:|
| gemma-4-31B-it | BRA | 0.3655 | 0.2638 | +0.1017 | +27.83% | ✅ |
| gemma-4-31B-it | CHN | 0.4536 | 0.4564 | -0.0028 | -0.61% | ❌ |
| gemma-4-31B-it | DEU | 0.3289 | 0.4785 | -0.1496 | -45.47% | ❌ |
| gemma-4-31B-it | JPN | 0.4667 | 0.4880 | -0.0213 | -4.57% | ❌ |
| gemma-4-31B-it | USA | 0.6038 | 0.4227 | +0.1811 | +29.99% | ✅ |

- Win rate vs EXP-01: **2/5**
- Mean EXP-01 MIS: **0.4437**
- Mean DPBR MIS: **0.4219**
- Macro improvement vs EXP-01: **+4.92%**

### Per-Dimension Worst Error

| Model | Country | Worst Dimension | Human | Model | \|err\| (pp) |
|:------|:-------:|:----------------|:-----:|:-----:|:------------:|
| gemma-4-31B-it | BRA | Age_Young | 73.6 | 59.2 | 14.3 |
| gemma-4-31B-it | CHN | Species_Humans | 83.0 | 47.4 | 35.6 |
| gemma-4-31B-it | DEU | Species_Humans | 82.4 | 45.0 | 37.4 |
| gemma-4-31B-it | JPN | Species_Humans | 79.8 | 46.6 | 33.2 |
| gemma-4-31B-it | USA | Utilitarianism_More | 76.6 | 50.3 | 26.2 |

### Notes

- **DPBR vs vanilla**: only **CHN** wins; **DEU** collapses (vanilla MIS **0.2477** → DPBR **0.4785**). **BRA** essentially tied.
- vs **EXP-01**: **2/5** (**BRA**, **USA**).
...
## Run: EXP-24-MAGISTRAL_SMALL_2509

- Date: 2026-04-11
- Script: `exp_model/exp_24/exp_magistral_small_2509.py`
- Model: `unsloth/Magistral-Small-2509-unsloth-bnb-4bit` (`MODEL_SHORT`: `magistral_small_2509`)
- Notebook: `Reference_Notebook_Model/new/unsloth-magistral-small-2509-unsloth-bnb-4bit.ipynb`
- Profile: **pypi** — `bitsandbytes`, `scipy`, `tqdm`, `sentencepiece`, `protobuf`; `pip install --upgrade --no-deps unsloth`, `unsloth_zoo`, `datasets` 3.4.x–4.4.x; align with the notebook above / Reference_Notebook_Model/new.
- Method: Dual-Pass Bootstrap IS Reliability (DPBR)
- Output dir: `/kaggle/working/cultural_alignment/results/exp24_model_sweep/magistral_small_2509/compare`
- Environment (Kaggle): 1× **NVIDIA H100 80GB**; Unsloth **2026.4.4** (“Fast Mistral patching”); Transformers **5.2.0**; Torch **2.9.0+cu126**; bfloat16; ~**15.07 GB** VRAM; decision token ids **A=1065, B=1066**. Vanilla debug prompts show Mistral-style **`<s>[SYSTEM_PROMPT]…[/SYSTEM_PROMPT][INST]…[/INST]`**. Pip may warn optional **xformers** / `bigframes` / `google-adk` vs `google-cloud-bigquery-storage` (non-fatal). Log: `FA [Xformers = None. FA2 = False]`.

### Vanilla baseline (token-logit, no personas / no IS)

| Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ |
|:-------:|:-----:|:-----:|:-----------:|:-----:|
| BRA | 0.4115 | 0.1063 | +0.017 | 15.50 |
| CHN | 0.3673 | 0.1014 | +0.637 | 12.48 |
| DEU | 0.2645 | 0.0675 | +0.581 | 9.75 |
| JPN | 0.3406 | 0.0752 | +0.784 | 10.48 |
| USA | 0.4480 | 0.1130 | +0.599 | 16.36 |

- Mean vanilla MIS: **0.3664** (same aggregate as in vs-DPBR table).

### Full Metrics (DPBR)

| Model | Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ | Flip% |
|:------|:-------:|:-----:|:-----:|:-----------:|:-----:|:-----:|
| Magistral-Small-2509-unsloth-bnb-4bit | BRA | 0.3203 | 0.0529 | +0.441 | 10.76 | 18.1% |
| Magistral-Small-2509-unsloth-bnb-4bit | CHN | 0.2944 | 0.0512 | +0.757 | 9.86 | 23.5% |
| Magistral-Small-2509-unsloth-bnb-4bit | DEU | 0.3096 | 0.0392 | +0.799 | 10.89 | 19.0% |
| Magistral-Small-2509-unsloth-bnb-4bit | JPN | 0.2864 | 0.0639 | +0.709 | 9.28 | 18.4% |
| Magistral-Small-2509-unsloth-bnb-4bit | USA | 0.3728 | 0.0436 | +0.777 | 14.00 | 18.4% |

### vs Vanilla (MIS)

| Model | Country | Vanilla MIS | DPBR MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|------------:|---------:|----------------:|--------:|:----:|
| Magistral-Small-2509-unsloth-bnb-4bit | BRA | 0.4115 | 0.3203 | +0.0912 | +22.16% | ✅ |
| Magistral-Small-2509-unsloth-bnb-4bit | CHN | 0.3673 | 0.2944 | +0.0729 | +19.86% | ✅ |
| Magistral-Small-2509-unsloth-bnb-4bit | DEU | 0.2645 | 0.3096 | -0.0451 | -17.07% | ❌ |
| Magistral-Small-2509-unsloth-bnb-4bit | JPN | 0.3406 | 0.2864 | +0.0542 | +15.92% | ✅ |
| Magistral-Small-2509-unsloth-bnb-4bit | USA | 0.4480 | 0.3728 | +0.0753 | +16.80% | ✅ |

- Win rate: **4/5**
- Mean vanilla MIS: **0.3664**
- Mean DPBR MIS: **0.3167**
- Macro improvement: **+13.56%**
- Mean per-row improvement (micro): **+11.53%**

### vs EXP-01 SWA-PTIS (MIS)

- Not reported in this run (`try_load_reference_comparison` returned no matching slice).

### Per-Dimension Worst Error

| Model | Country | Worst Dimension | Human | Model | \|err\| (pp) |
|:------|:-------:|:----------------|:-----:|:-----:|:------------:|
| Magistral-Small-2509-unsloth-bnb-4bit | BRA | Age_Young | 73.6 | 52.3 | 21.2 |
| Magistral-Small-2509-unsloth-bnb-4bit | CHN | SocialValue_High | 66.7 | 45.8 | 21.0 |
| Magistral-Small-2509-unsloth-bnb-4bit | DEU | Species_Humans | 82.4 | 63.0 | 19.5 |
| Magistral-Small-2509-unsloth-bnb-4bit | JPN | SocialValue_High | 65.9 | 41.4 | 24.5 |
| Magistral-Small-2509-unsloth-bnb-4bit | USA | SocialValue_High | 67.9 | 46.0 | 21.9 |

### Notes

- **DPBR vs vanilla**: wins **USA, CHN, JPN, BRA**; only **DEU** regresses (vanilla MIS was already strongest at **0.2645**, so IS hurts on that slice).
- Aggregate: DPBR mean MIS **0.3167**, mean JSD **0.0502**, mean Pearson **+0.697**, mean flip **19.5%**, mean `rel_r` **0.960**; per-country latency in log ~**440–650 ms**/scenario (vs EXP-09 SOTA MIS 0.3975; EXP-24 multi-model ref 0.3969).
- Worst dimensions: **SocialValue_High** (**USA**, **CHN**, **JPN**), **Age_Young** (**BRA**), **Species_Humans** (**DEU**).
...
## Run: EXP-24-CODEGEMMA_7B

- Date: 2026-04-11
- Script: `exp_model/exp_24/exp_codegemma_7b.py`
- Model: `unsloth/codegemma-7b-bnb-4bit` (`MODEL_SHORT`: `codegemma_7b`)
- Profile: **pypi** — `pip install --upgrade --no-deps unsloth`; `pip install -q unsloth_zoo`; `datasets` 3.4.x–4.4.x; align with Reference_Notebook_Model / CodeGemma_(7B)_Conversational.ipynb where noted. **ChatML** applied via `get_chat_template` in `src/model.py` `load_model`.
- Method: Dual-Pass Bootstrap IS Reliability (DPBR)
- Output dir: `/kaggle/working/cultural_alignment/results/exp24_model_sweep/codegemma_7b/compare`
- Environment (Kaggle): 1× **NVIDIA H100 80GB**; Unsloth **2026.4.4** (“Fast Gemma patching”); Transformers **5.2.0**; Torch **2.9.0+cu126**; bfloat16; ~**5.63 GB** VRAM at load; ChatML in vanilla: `<bos><|im_start|>system` … `<|im_start|>user` … `<|im_start|>assistant`; decision tokens **A=235280 (`'A'`), B=235305 (`'B'`)** (same ids across langs). Pip may warn **xformers** (optional; Unsloth lists it) / `bigframes` / `google-adk` deps.

### Vanilla baseline (token-logit, no personas / no IS)

| Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ |
|:-------:|:-----:|:-----:|:-----------:|:-----:|
| BRA | 0.4192 | 0.0492 | -0.841 | 15.40 |
| CHN | 0.4678 | 0.0588 | +0.801 | 16.68 |
| DEU | 0.5017 | 0.0624 | +0.258 | 18.04 |
| JPN | 0.4417 | 0.0550 | +0.822 | 15.89 |
| USA | 0.5111 | 0.0544 | +0.463 | 18.95 |

- Mean vanilla MIS: **0.4683**

### Full Metrics (DPBR)

| Model | Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ | Flip% |
|:------|:-------:|:-----:|:-----:|:-----------:|:-----:|:-----:|
| codegemma-7b-bnb-4bit | BRA | 0.4168 | 0.0495 | -0.223 | 15.28 | 22.6% |
| codegemma-7b-bnb-4bit | CHN | 0.4730 | 0.0598 | -0.284 | 16.85 | 2.9% |
| codegemma-7b-bnb-4bit | DEU | 0.5099 | 0.0639 | -0.309 | 18.18 | 18.7% |
| codegemma-7b-bnb-4bit | JPN | 0.4402 | 0.0545 | +0.128 | 15.85 | 22.6% |
| codegemma-7b-bnb-4bit | USA | 0.5126 | 0.0590 | -0.656 | 18.76 | 24.8% |

### vs Vanilla (MIS)

| Model | Country | Vanilla MIS | DPBR MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|------------:|---------:|----------------:|--------:|:----:|
| codegemma-7b-bnb-4bit | BRA | 0.4192 | 0.4168 | +0.0023 | +0.56% | ✅ |
| codegemma-7b-bnb-4bit | CHN | 0.4678 | 0.4730 | -0.0051 | -1.10% | ❌ |
| codegemma-7b-bnb-4bit | DEU | 0.5017 | 0.5099 | -0.0081 | -1.62% | ❌ |
| codegemma-7b-bnb-4bit | JPN | 0.4417 | 0.4402 | +0.0015 | +0.35% | ✅ |
| codegemma-7b-bnb-4bit | USA | 0.5111 | 0.5126 | -0.0015 | -0.30% | ❌ |

- Win rate: **2/5**
- Mean vanilla MIS: **0.4683**
- Mean DPBR MIS: **0.4705**
- Macro improvement: **-0.47%**
- Mean per-row improvement (micro): **-0.42%**

### vs EXP-01 SWA-PTIS (MIS)

| Model | Country | EXP-01 MIS | DPBR MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|-----------:|---------:|----------------:|--------:|:----:|
| codegemma-7b-bnb-4bit | BRA | 0.3655 | 0.4168 | -0.0513 | -14.04% | ❌ |
| codegemma-7b-bnb-4bit | CHN | 0.4536 | 0.4730 | -0.0194 | -4.27% | ❌ |
| codegemma-7b-bnb-4bit | DEU | 0.3289 | 0.5099 | -0.1810 | -55.02% | ❌ |
| codegemma-7b-bnb-4bit | JPN | 0.4667 | 0.4402 | +0.0265 | +5.69% | ✅ |
| codegemma-7b-bnb-4bit | USA | 0.6038 | 0.5126 | +0.0912 | +15.11% | ✅ |

- Win rate vs EXP-01: **2/5**
- Mean EXP-01 MIS: **0.4437**
- Mean DPBR MIS: **0.4705**
- Macro improvement vs EXP-01: **-6.03%**

### Per-Dimension Worst Error

| Model | Country | Worst Dimension | Human | Model | \|err\| (pp) |
|:------|:-------:|:----------------|:-----:|:-----:|:------------:|
| codegemma-7b-bnb-4bit | BRA | Age_Young | 73.6 | 49.1 | 24.5 |
| codegemma-7b-bnb-4bit | CHN | Species_Humans | 83.0 | 49.3 | 33.7 |
| codegemma-7b-bnb-4bit | DEU | Species_Humans | 82.4 | 49.3 | 33.1 |
| codegemma-7b-bnb-4bit | JPN | Species_Humans | 79.8 | 49.8 | 30.0 |
| codegemma-7b-bnb-4bit | USA | Species_Humans | 79.2 | 49.2 | 30.0 |

### Notes

- DPBR slightly hurts on average vs vanilla (**2/5** wins; macro **-0.47%**). Best gains: **JPN**, **BRA**; worst: **DEU**, **CHN**.
- **Species_Humans** is the top worst-dimension row in **4/5** countries; **Age_Young** dominates in **BRA**.
- Latency ~**155–186 ms**/scenario in log (DPBR forward).
- Aggregate: DPBR mean MIS **0.4705**, mean JSD **0.0573**, mean Pearson **-0.269**, mean flip **18.3%**, mean `rel_r` **0.980** (vs EXP-09 SOTA MIS 0.3975; EXP-24 multi-model ref 0.3969).
...
## Run: EXP-24-QWEN3_14B

- Date: 2026-04-11
- Script: `exp_model/exp_24/exp_qwen3_14b.py`
- Model: `unsloth/Qwen3-14B-unsloth-bnb-4bit` (`MODEL_SHORT`: `qwen3_14b`)
- Notebook: `Reference_Notebook_Model/Qwen3_(14B)_Reasoning_Conversational.ipynb`
- Profile: **ref_qwen3** — `transformers==4.56.2`, `trl==0.22.2` (`--no-deps`); same pip stack as `exp_qwen3_32b.py`; Unsloth + unsloth-zoo from PyPI.
- Method: Dual-Pass Bootstrap IS Reliability (DPBR)
- Output dir: `/kaggle/working/cultural_alignment/results/exp24_model_sweep/qwen3_14b/compare`
- Environment (Kaggle): 1× **NVIDIA H100 80GB**; Unsloth **2026.4.4** (“Fast Qwen3 patching”); Transformers **4.56.2**; Torch **2.9.0+cu126**; bfloat16; ~**11.14 GB** VRAM; Qwen3 chat template (`<|im_start|>` …); decision token ids **A=32, B=33**; pip warnings optional **xformers** / `bigframes` / `google-adk`. Log: padding token fallback for this checkpoint.

### Vanilla baseline (token-logit, no personas / no IS)

| Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ |
|:-------:|:-----:|:-----:|:-----------:|:-----:|
| BRA | 0.4135 | 0.0499 | -0.216 | 15.11 |
| CHN | 0.4267 | 0.0502 | +0.726 | 15.36 |
| DEU | 0.5040 | 0.0627 | +0.574 | 17.99 |
| JPN | 0.3720 | 0.0357 | +0.789 | 14.05 |
| USA | 0.5093 | 0.0551 | +0.445 | 18.84 |
...
| Model | Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ | Flip% |
|:------|:-------:|:-----:|:-----:|:-----------:|:-----:|:-----:|
| Qwen3-14B-unsloth-bnb-4bit | BRA | 0.4138 | 0.0495 | -0.279 | 15.15 | 19.7% |
| Qwen3-14B-unsloth-bnb-4bit | CHN | 0.4691 | 0.0592 | -0.274 | 16.71 | 1.0% |
| Qwen3-14B-unsloth-bnb-4bit | DEU | 0.4983 | 0.0622 | +0.276 | 17.75 | 27.1% |
| Qwen3-14B-unsloth-bnb-4bit | JPN | 0.4371 | 0.0547 | +0.413 | 15.69 | 15.2% |
| Qwen3-14B-unsloth-bnb-4bit | USA | 0.5039 | 0.0544 | +0.415 | 18.63 | 26.5% |

### vs Vanilla (MIS)

| Model | Country | Vanilla MIS | DPBR MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|------------:|---------:|----------------:|--------:|:----:|
| Qwen3-14B-unsloth-bnb-4bit | BRA | 0.4135 | 0.4138 | -0.0003 | -0.07% | ❌ |
| Qwen3-14B-unsloth-bnb-4bit | CHN | 0.4267 | 0.4691 | -0.0425 | -9.96% | ❌ |
| Qwen3-14B-unsloth-bnb-4bit | DEU | 0.5040 | 0.4983 | +0.0057 | +1.13% | ✅ |
| Qwen3-14B-unsloth-bnb-4bit | JPN | 0.3720 | 0.4371 | -0.0651 | -17.49% | ❌ |
| Qwen3-14B-unsloth-bnb-4bit | USA | 0.5093 | 0.5039 | +0.0053 | +1.05% | ✅ |

- Win rate: **2/5**
- Mean vanilla MIS: **0.4451**
- Mean DPBR MIS: **0.4645**
- Macro improvement: **-4.35%**
- Mean per-row improvement (micro): **-5.07%**

### vs EXP-01 SWA-PTIS (MIS)

| Model | Country | EXP-01 MIS | DPBR MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|-----------:|---------:|----------------:|--------:|:----:|
| Qwen3-14B-unsloth-bnb-4bit | BRA | 0.4025 | 0.4138 | -0.0113 | -2.81% | ❌ |
| Qwen3-14B-unsloth-bnb-4bit | CHN | 0.4078 | 0.4691 | -0.0613 | -15.04% | ❌ |
| Qwen3-14B-unsloth-bnb-4bit | DEU | 0.3424 | 0.4983 | -0.1559 | -45.54% | ❌ |
| Qwen3-14B-unsloth-bnb-4bit | JPN | 0.2802 | 0.4371 | -0.1569 | -56.00% | ❌ |
| Qwen3-14B-unsloth-bnb-4bit | USA | 0.3677 | 0.5039 | -0.1362 | -37.05% | ❌ |

- Win rate vs EXP-01: **0/5**
- Mean EXP-01 MIS: **0.3601**
- Mean DPBR MIS: **0.4645**
- Macro improvement vs EXP-01: **-28.98%**
...
| Qwen3-14B-unsloth-bnb-4bit | BRA | Age_Young | 73.6 | 49.8 | 23.8 |
| Qwen3-14B-unsloth-bnb-4bit | CHN | Species_Humans | 83.0 | 49.7 | 33.3 |
| Qwen3-14B-unsloth-bnb-4bit | DEU | Species_Humans | 82.4 | 50.1 | 32.4 |
| Qwen3-14B-unsloth-bnb-4bit | JPN | Species_Humans | 79.8 | 50.3 | 29.6 |
| Qwen3-14B-unsloth-bnb-4bit | USA | Species_Humans | 79.2 | 50.0 | 29.2 |

### Notes

- DPBR vs vanilla: **2/5** wins (**USA**, **DEU**); large regression **JPN** (vanilla MIS **0.3720** → DPBR **0.4371**).
- vs **EXP-01**: **0/5** on this table.
- **Species_Humans** worst dim in **4/5** countries; **BRA** worst is **Age_Young**.
- Latency ~**200–300 ms**/scenario (DPBR) in log.
- Aggregate: DPBR mean MIS **0.4645**, mean JSD **0.0560**, mean Pearson **+0.110**, mean flip **17.9%**, mean `rel_r` **0.994** (vs EXP-09 SOTA MIS 0.3975; EXP-24 multi-model ref 0.3969).
...
## Run: EXP-24-ERNIE45_21B_A3B

- Date: 2026-04-11
- Script: `exp_model/exp_24/exp_ernie45_21b_a3b.py`
- Model: `unsloth/ERNIE-4.5-21B-A3B-PT` (`MODEL_SHORT`: `ernie45_21b_a3b`)
- Notebook: `Reference_Notebook_Model/new/unslothERNIE-4.5-21B-A3B-PT.ipynb`
- Profile: **pypi** — `bitsandbytes`, `scipy`, `tqdm`, `sentencepiece`, `protobuf`; `pip install --upgrade --no-deps unsloth`, `unsloth_zoo`, pin `transformers==4.56.2` (align with notebook), `datasets` 3.4.x–4.4.x.
- Method: Dual-Pass Bootstrap IS Reliability (DPBR)
- Output dir: `/kaggle/working/cultural_alignment/results/exp24_model_sweep/ernie45_21b_a3b/compare`
- Environment (Kaggle): 1× **NVIDIA H100 80GB**; Unsloth **2026.4.4** (“Fast Ernie4_5_MoE patching”); Transformers **5.2.0** (run log; env may differ from pin order); Torch **2.9.0+cu126**; bfloat16; ~**41.97 GB** VRAM; decision token ids **A=355 (`' A'`), B=408 (`' B'`)**. Pip may warn optional **xformers** / `bigframes` / `google-adk` deps. Chat wrapper: `<|begin_of_sentence|>` … `User:` / `Assistant:`.

### Vanilla baseline (token-logit, no personas / no IS)

| Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ |
|:-------:|:-----:|:-----:|:-----------:|:-----:|
| BRA | 0.3540 | 0.0650 | -0.160 | 13.34 |
| CHN | 0.3269 | 0.0841 | +0.804 | 12.17 |
| DEU | 0.2175 | 0.0557 | +0.684 | 6.48 |
| JPN | 0.2708 | 0.0718 | +0.533 | 8.48 |
| USA | 0.3095 | 0.0730 | +0.735 | 10.17 |

- Mean vanilla MIS: **0.2957**

### Full Metrics (DPBR)

| Model | Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ | Flip% |
|:------|:-------:|:-----:|:-----:|:-----------:|:-----:|:-----:|
| ERNIE-4.5-21B-A3B-PT | BRA | 0.3390 | 0.0563 | +0.087 | 12.16 | 19.0% |
| ERNIE-4.5-21B-A3B-PT | CHN | 0.3140 | 0.0552 | +0.578 | 10.55 | 16.1% |
| ERNIE-4.5-21B-A3B-PT | DEU | 0.3832 | 0.0614 | +0.245 | 12.63 | 17.7% |
| ERNIE-4.5-21B-A3B-PT | JPN | 0.3924 | 0.0644 | +0.190 | 13.01 | 25.5% |
| ERNIE-4.5-21B-A3B-PT | USA | 0.3750 | 0.0406 | +0.691 | 13.92 | 13.2% |

### vs Vanilla (MIS)

| Model | Country | Vanilla MIS | DPBR MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|------------:|---------:|----------------:|--------:|:----:|
| ERNIE-4.5-21B-A3B-PT | BRA | 0.3540 | 0.3390 | +0.0150 | +4.24% | ✅ |
| ERNIE-4.5-21B-A3B-PT | CHN | 0.3269 | 0.3140 | +0.0129 | +3.94% | ✅ |
| ERNIE-4.5-21B-A3B-PT | DEU | 0.2175 | 0.3832 | -0.1658 | -76.23% | ❌ |
| ERNIE-4.5-21B-A3B-PT | JPN | 0.2708 | 0.3924 | -0.1216 | -44.89% | ❌ |
| ERNIE-4.5-21B-A3B-PT | USA | 0.3095 | 0.3750 | -0.0656 | -21.18% | ❌ |

- Win rate: **2/5**
- Mean vanilla MIS: **0.2957**
- Mean DPBR MIS: **0.3607**
- Macro improvement: **-21.98%**
- Mean per-row improvement (micro): **-26.82%**
...
| Model | Country | Worst Dimension | Human | Model | \|err\| (pp) |
|:------|:-------:|:----------------|:-----:|:-----:|:------------:|
| ERNIE-4.5-21B-A3B-PT | BRA | Age_Young | 73.6 | 50.5 | 23.1 |
| ERNIE-4.5-21B-A3B-PT | CHN | Species_Humans | 83.0 | 63.3 | 19.7 |
| ERNIE-4.5-21B-A3B-PT | DEU | Species_Humans | 82.4 | 55.7 | 26.8 |
| ERNIE-4.5-21B-A3B-PT | JPN | Species_Humans | 79.8 | 54.1 | 25.8 |
| ERNIE-4.5-21B-A3B-PT | USA | Age_Young | 74.5 | 50.6 | 24.0 |

### Notes

- **DPBR vs vanilla**: wins only **BRA** and **CHN**; **DEU**/**JPN**/**USA** regress strongly — vanilla MIS was already low on **DEU**/**JPN** (especially DEU **0.2175**), similar pattern to other models with “too good” vanilla baselines.
- Aggregate: DPBR mean MIS **0.3607**, mean JSD **0.0556**, mean Pearson **+0.358**, mean flip **18.3%**, mean `rel_r` **0.924** (vs EXP-09 SOTA MIS 0.3975; EXP-24 multi-model ref 0.3969).
- Worst residuals: **Age_Young** (**USA**, **BRA**) or **Species_Humans** (**DEU**, **JPN**, **CHN**).

---

## Run: EXP-09-LLAMA33_70B

- Date: 2026-04-11
- Script: `exp_model/exp9/exp_llama33_70b.py`
- Model: `unsloth/Llama-3.3-70B-Instruct-bnb-4bit` (`MODEL_SHORT`: `llama33_70b`)
- Profile: **pypi** — `pip install --upgrade --no-deps unsloth`; `pip install -q unsloth_zoo`; `datasets` 3.4.x–4.4.x; align with Reference_Notebook_Model where noted.
- Method: Hierarchical IS with Country-Level Prior (EXP-09); `alpha_h(t)` ramp; `delta_opt = alpha_h*delta_country + (1-alpha_h)*delta_opt_micro`.
- Output dir: `/kaggle/working/cultural_alignment/results/exp09_model_sweep/llama33_70b/compare`
- Environment (Kaggle): 1× **NVIDIA H100 80GB**; Unsloth **2026.4.4** (“Fast Llama patching”); Transformers **5.2.0**; Torch **2.9.0+cu126**; ~**39.6 GB** VRAM at load; Llama 3.x chat tokens **A=32, B=33**. Pip may warn optional **xformers** / `bigframes` / `google-adk` deps. Vanilla baseline MIS is very high on this checkpoint (especially **USA**/**CHN**); Hierarchical IS collapses much of that gap (**5/5** wins vs vanilla).

### Full Metrics (Hierarchical IS)

| Model | Country | MIS ↓ | JSD ↓ | Pearson r ↑ | MAE ↓ | Flip% |
|:------|:-------:|:-----:|:-----:|:-----------:|:-----:|:-----:|
| Llama-3.3-70B | BRA | 0.4107 | 0.1076 | +0.317 | 12.96 | 18.7% |
| Llama-3.3-70B | CHN | 0.6738 | 0.1490 | +0.110 | 22.50 | 16.8% |
| Llama-3.3-70B | DEU | 0.5629 | 0.1571 | +0.168 | 15.50 | 12.6% |
| Llama-3.3-70B | JPN | 0.4083 | 0.0967 | +0.335 | 13.11 | 20.3% |
| Llama-3.3-70B | USA | 0.5628 | 0.1177 | +0.303 | 18.02 | 13.9% |

### vs Vanilla (MIS)

| Model | Country | Vanilla MIS | Hierarchical IS MIS | Delta (ref-cur) | Improv% | Win? |
|:------|:-------:|------------:|--------------------:|----------------:|--------:|:----:|
| Llama-3.3-70B | BRA | 0.5213 | 0.4107 | +0.1106 | +21.22% | ✅ |
| Llama-3.3-70B | CHN | 0.9010 | 0.6738 | +0.2272 | +25.21% | ✅ |
| Llama-3.3-70B | DEU | 0.7155 | 0.5629 | +0.1526 | +21.32% | ✅ |
| Llama-3.3-70B | JPN | 0.5206 | 0.4083 | +0.1123 | +21.57% | ✅ |
| Llama-3.3-70B | USA | 0.8730 | 0.5628 | +0.3102 | +35.53% | ✅ |

- Win rate: **5/5**
- Mean vanilla MIS: **0.7063**
- Mean Hierarchical IS MIS: **0.5237**
- Macro improvement: **+25.85%**
- Mean per-row improvement (micro): **+24.97%**

### Per-Dimension Worst Error

| Model | Country | Worst Dimension | Human | Model | \|err\| (pp) |
|:------|:-------:|:----------------|:-----:|:-----:|:------------:|
| Llama-3.3-70B | BRA | SocialValue_High | 66.3 | 31.3 | 35.0 |
| Llama-3.3-70B | CHN | SocialValue_High | 66.7 | 19.4 | 47.3 |
| Llama-3.3-70B | DEU | Utilitarianism_More | 75.1 | 28.5 | 46.7 |
| Llama-3.3-70B | JPN | SocialValue_High | 65.9 | 31.7 | 34.2 |
| Llama-3.3-70B | USA | Utilitarianism_More | 76.6 | 33.7 | 42.8 |

### Notes

- Strong **5/5** vs vanilla; largest relative gain in **USA** (vanilla MIS 0.87 → 0.56).
- Residual gaps concentrate on **SocialValue_High** and **Utilitarianism_More** (model MPR often ~30–40% vs human 65–77%).
- Aggregate: mean JSD **0.1256**, mean Pearson **+0.247**, mean flip **16.5%**, mean latency ~**1.0–1.3 s**/scenario from log (vs EXP-09 SOTA MIS 0.3975).

#!/usr/bin/env python3
"""
EXP-24 Dual-Pass Bootstrap IS — Qwen2.5-32B-Instruct (4-bit)
===========================================================
...
Usage on Kaggle
---------------
    !python exp_model/exp_24/exp_qwen25_32b.py

VRAM: 32B @ 4-bit — use A100 40GB/80GB or H100; single T4 will not load.

Note: Qwen2.5 line (distinct from Qwen3-32B in exp_qwen3_32b.py).
"""

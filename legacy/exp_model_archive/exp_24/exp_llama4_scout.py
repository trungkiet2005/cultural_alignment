#!/usr/bin/env python3
"""
EXP-24 Dual-Pass Bootstrap IS — Llama-4-Scout-17B-16E-Instruct (TF 5.5 stack)
=============================================================================
...
Profile: ref_git_tf55  (pip stack aligned with Reference_Notebook_Model where noted)
         Llama-4 uses FastModel (Llama4ForConditionalGeneration), not FastLanguageModel (causal-LM path).

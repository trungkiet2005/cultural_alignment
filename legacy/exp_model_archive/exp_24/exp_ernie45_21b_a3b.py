#!/usr/bin/env python3
"""
EXP-24 Dual-Pass Bootstrap IS — ERNIE-4.5-21B-A3B-PT
====================================================
...
Usage on Kaggle
---------------
    !python exp_model/exp_24/exp_ernie45_21b_a3b.py

Note: ~21B-class checkpoint — use a high-VRAM GPU session if inference OOMs on smaller tiers.
...
def _install_deps() -> None:
    if not _on_kaggle():
        return
    # Notebook (new/unslothERNIE-4.5-21B-A3B-PT.ipynb) pins transformers==4.56.2.
    for cmd in [
